...
urlpatterns = [
    ...
    path('transacoes/lista/', views.transacoes, name='transacao_list'),
    ...
    path('adicionar-transacao/', views.adicionar_transacao, name='adicionar_transacao'),
    ...
    path('parcela/marcar-paga/<int:transacao_id>/', views.marcar_parcela_paga, name='marcar_parcela_paga'),
    path('parcela/marcar-nao-paga/<int:transacao_id>/', views.marcar_parcela_nao_paga, name='marcar_parcela_nao_paga'),
    path('parcela/<int:transacao_id>/pagar/', views.processar_pagamento_parcela, name='processar_pagamento_parcela'),
    path('contas/', views.contas, name='contas'),
    path('contas/lista/', views.contas, name='conta_list'),
    path('contas/criar/', views.contas, name='conta_create'),
    path('contas/editar/<int:conta_id>/', views.editar_conta, name='conta_update'),
    ...
    path('contas/excluir/<int:conta_id>/', views.excluir_conta, name='conta_delete'),
