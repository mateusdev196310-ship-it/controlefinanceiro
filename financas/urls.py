...
urlpatterns = [
    ...
    path('transacoes/importar/', views.importar_transacoes, name='importar_transacoes'),
    path('transacoes/download-modelo/', views.download_modelo_planilha, name='download_modelo_planilha'),
